...
$(document).ready(function(){
	...
	var a = $('#view_{rand}').bootstable({
		...
		columns:[{
			...
			text:'核算時間',dataIndex:'optdt',sortable:true
		},{
			text:'實發工資',dataIndex:'money',sortable:true
		},{
			text:'是否核算',dataIndex:'isturnss'
		},{
			text:'發放',dataIndex:'ispay',sortable:true
		},{
	...
	var c = {
		...
		daoru:function(){
			...
			addtabs({num:'daoru'+modenum+'',url:'flow,input,daoru,modenum='+modenum+'',icons:'plus',name:'導入薪資核算'});
		}
	};
	js.initbtn(c);
});
...
<div>
	...
	<td style="padding:0px 10px">
		<button class="btn btn-default" click="create" type="button">一鍵生成人員核算數據</button> 
	</td>
	<td width="80%">
...
<div class="tishi">提示：薪資核算前，請先核算考勤狀態哦，需要核算+已審核才能發放哦！</div>
