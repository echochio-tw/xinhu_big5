...
<div align="center" id="mainv{rand}" style="background:url(images/cropbg.gif);position:relative">
	<div style="left:10px;top:20px" class="rf rf_ract"><div style="padding:10px">圖形1</div></div>
	<div style="left:10px;top:100px" class="rf rf_yuan"><div style="padding:10px">圖形1</div></div>
