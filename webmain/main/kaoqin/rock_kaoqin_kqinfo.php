...
$(document).ready(function(){
	...
	var a = $('#view_{rand}').bootstable({
		...
		columns:[{
			...
			text:'時間',dataIndex:'totals',sortable:true
		},{
	...
	var c = {
		...
		clickwin:function(o1, lx){
			if(lx==0)openinput('請假條','leave');
			if(lx==1)openinput('加班單','jiaban');
		}
	};
...
<table width="100%"><tr>
	<td style="padding-right:10px">
		<button class="btn btn-primary" click="clickwin,0" type="button">新增請假條</button>
	</td>
	<td style="padding-right:10px">
		<button class="btn btn-primary" click="clickwin,1" type="button">新增加班單</button>
	</td>
	<td nowrap>日期從&nbsp;</td>
	<td nowrap>
...
<div>我考勤信息統計：<span id="kqtong{rand}"></span></div>
<div class="blank10"></div>
