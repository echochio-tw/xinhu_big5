...
<tr>
	...
	<td>
		...
		<option value="deptname">部門</option>
		<option value="sex">性別</option>
		<option value="xueli">學歷</option>
		<option value="nian">年齡</option>
		<option value="year">入職年份</option>
		<option value="nianxian">入職年限</option>
		<option value="state">人員狀態</option>
		<option value="ranking">職位</option>
		</select>
	</td>
	<td  style="padding-left:10px">
		<div style="width:140px"  class="input-group">
			<input placeholder="入職日期" readonly class="form-control" id="dt_{rand}" >
