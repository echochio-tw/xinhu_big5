...
$(document).ready(function(){
	{params}
	var modenum = 'daily',modename='工作日報',isflow=0,modeid='3',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
var fieldsarr = [{"name":"申請人","fields":"base_name"},{"name":"申請人部門","fields":"base_deptname"},{"name":"單號","fields":"sericnum"},{"fields":"deptname","name":"部門","fieldstype":"text","ispx":"0","isalign":" 0","islb":"1"},{"fields":"optname","name":"人員","fieldstype":"text","ispx":"0","isalign":" 0","islb":"1"},{"fields":"type","name":"日報類型","fieldstype":"select","ispx":"1","isalign": "0","islb":"1"},{"fields":"dt","name":"日期","fieldstype":"date","ispx":"1","isalign": "0","islb":"1"},{"fields":"enddt","name":"截止日期","fieldstype":"date","ispx":"0","isalign" :"0","islb":"0"},{"fields":"content","name":"內容","fieldstype":"textarea","ispx":"0","isalign" :"1","islb":"1"},{"fields":"plan","name":"明日計劃","fieldstype":"textarea","ispx":"0","isalign ":"0","islb":"0"},{"fields":"adddt","name":"新增時間","fieldstype":"hidden","ispx":"0", "isalign":"0","islb":"1"},{"fields":"mark","name":"評分分數","fieldstype":"text","ispx":"0" ,"isalign":"0"," islb":"0"},{"fields":"optdt","name":"操作時間","fieldstype":"datetime","ispx":"1","isalign":"0", "islb":"1"}],fieldsselarr= [];
	var c = {
		reload:function(){
			a.reload();
		},
		...
		subscribelist:function(){
			js.subscribe({
				title:'工作日報('+nowtabs.name+')',
				cont:'工作日報('+nowtabs.name+')的列表的',
				explain:'訂閱[工作日報]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorudaily',url:'flow,input,daoru,modenum=daily',icons:'plus',name:'導入工作日報'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"部門",dataIndex:"deptname"},{text:"人員",dataIndex:"optname"},{text:"日報類型",dataIndex:"type",sortable:true},{text:"日期",dataIndex:"dt",sortable:true},{text:"內容",dataIndex:"content",align:"left"},{text:"新增時間",dataIndex:"adddt"},{text:"操作時間",dataIndex:"optdt",sortable:true},{
