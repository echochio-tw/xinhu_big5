...
$(document).ready(function(){
	{params}
	var modenum = 'carmrese',modename='車輛預定',isflow=1,modeid='44',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
var fieldsarr = [{"name":"申請人","fields":"base_name"},{"name":"申請人部門","fields":"base_deptname"},{"name":"單號","fields":"sericnum"},{"fields":"usename","name":"使用者","fieldstype":"changedeptusercheck","ispx":"0","isalign": "0","islb":"1"},{"fields":"useren","name":"使用人數","fieldstype":"number","ispx":"0","isalign" :"0","islb":"1"},{"fields":"startdt","name":"開始時間","fieldstype":"datetime","ispx":"0","isalign ":"0","islb":"1"},{"fields":"enddt","name":"截止時間","fieldstype":"datetime","ispx":"0"," isalign":"0","islb":"1"},{"fields":"address","name":"目的地","fieldstype":"text","ispx":"0", "isalign":"0","islb":"1"},{"fields":"xianlines","name":"線路","fieldstype":"text","ispx":"0", "isalign":"0","islb":"1"},{"fields":"carid","name":"預定車輛","fieldstype":"hidden","ispx":"0" ,"isalign":"0","islb":"0"},{"fields":"carnum","name":"車牌號","fieldstype":"selectdatafalse","ispx":"0 ","isalign":"0","islb":"1"},{"fields":"jianame","name":"駕駛員"," fieldstype":"changeusercheck","ispx":"0","isalign":"0","islb":"1"},{"fields":"kmstart","name":"起始公里數","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"kmend","name":"結束公里數","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"returndt","name": "歸還時間","fieldstype":"datetime","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name" :"說明","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	var c = {
		reload:function(){
			a.reload();
		},
		...
		subscribelist:function(){
			js.subscribe({
				title:'車輛預定('+nowtabs.name+')',
				cont:'車輛預定('+nowtabs.name+')的列表的',
				explain:'訂閱[車輛預定]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorucarmrese',url:'flow,input,daoru,modenum=carmrese',icons:'plus',name:'導入車輛預定'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"使用者",dataIndex:"usename"},{text:"使用人數",dataIndex:"useren"},{text:"開始時間",dataIndex:"startdt"},{text:"截止時間",dataIndex:"enddt"},{text:"目的地",dataIndex:"address"},{text:"線路",dataIndex:"xianlines"},{text:"車牌號",dataIndex:"carnum"},{text:"駕駛員",dataIndex:"jianame"},{text:"起始公裡數",dataIndex:"kmstart"},{text:"結束公裡數",dataIndex:"kmend"},{text:"歸還時間",dataIndex:"returndt"},{text:"說明",dataIndex:"explain"},{text:"狀態",dataIndex:"statustext"},{
