...
$(document).ready(function(){
	{params}
	var modenum = 'bookborrow',modename='圖書借閱',isflow=1,modeid='46',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
var fieldsarr = [{"name":"申請人","fields":"base_name"},{"name":"申請人部門","fields":"base_deptname"},{"name":"單號","fields":"sericnum"},{"fields":"bookid","name":"借閱書名","fieldstype":"hidden","ispx":"0","isalign" :"0","islb":"0"},{"fields":"bookname","name":"借閱書名","fieldstype":"selectdatafalse","ispx":"0"," isalign":"0","islb":"1"},{"fields":"jydt","name":"借閱日期","fieldstype":"date","ispx":"1", "isalign":"0","islb":"1"},{"fields":"yjdt","name":"預計歸還","fieldstype":"date","ispx":"1" ,"isalign":"0","islb":"1"},{"fields":"ghtime","name":"歸還時間","fieldstype":"datetime","ispx":"0 ","isalign":"0","islb":"1"},{"fields":"isgh","name":"是否歸返","fieldstype":"select","ispx": "1","isalign":"0","islb":"1"},{"fields":"explain","name":"說明","fieldstype":"textarea","ispx": "0","isalign":"0","islb":"1"}],fieldsselarr= [];
	var c = {
		reload:function(){
			a.reload();
		},
		...
		subscribelist:function(){
			js.subscribe({
				title:'圖書借閱('+nowtabs.name+')',
				cont:'圖書借閱('+nowtabs.name+')的列表的',
				explain:'訂閱[圖書借閱]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorubookborrow',url:'flow,input,daoru,modenum=bookborrow',icons:'plus',name:'導入圖書借閱'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"借閱書名",dataIndex:"bookname"},{text:"借閱日期",dataIndex:"jydt",sortable:true},{text:"預計歸還",dataIndex:"yjdt",sortable:true},{text:"歸還時間",dataIndex:"ghtime"},{text:"是否歸返",dataIndex:"isgh",sortable:true},{text:"說明",dataIndex:"explain"},{text:"狀態",dataIndex:"statustext"},{
...
c.initpage=function(){
	$('#key_{rand}').parent().before('<td style="padding-right:10px;"><input onclick="js.datechange(this,\'date\')" style="width:110px" placeholder="借閱日期" readonly class="form-control datesss" id="dt_{rand}" ></td>');
}
