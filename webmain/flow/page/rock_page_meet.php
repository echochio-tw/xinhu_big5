...
$(document).ready(function(){
	{params}
	var modenum = 'meet',modename='會議',isflow=0,modeid='2',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
var fieldsarr = [{"name":"申請人","fields":"base_name"},{"name":"申請人部門","fields":"base_deptname"},{"name":"單號","fields":"sericnum"},{"fields":"hyname","name":"會議室","fieldstype":"rockcombo","ispx":"1","isalign": "0","islb":"1"},{"fields":"title","name":"主題","fieldstype":"text","ispx":"0","isalign": "1","islb":"1"},{"fields":"startdt","name":"開始時間","fieldstype":"datetime","ispx":"0","isalign" :"0","islb":"1"},{"fields":"enddt","name":"結束時間","fieldstype":"datetime","ispx":"0","isalign ":"0","islb":"1"},{"fields":"joinname","name":"參會人","fieldstype":"changedeptusercheck","ispx":"0", "isalign":"0","islb":"1"},{"fields":"explain","name":"說明","fieldstype":"textarea","ispx":"0", "isalign":"0","islb":"1"},{"fields":"optname","name":"發起人","fieldstype":"text","ispx":"1" ,"isalign":"0","islb":"1"},{"fields":"state","name":"狀態","fieldstype":"text","ispx":"1" ,"isalign":"0","islb":"1"},{"fields":"jyname","name":"會議紀要人","fieldstype":"ch angeusercheck","ispx":"0","isalign":"0","islb":"1"},{"fields":"content","name":"會議紀要內容","fieldstype" :"htmlediter","ispx":"0","isalign":"0","islb":"0"}],fieldsselarr= [];
	var c = {
		reload:function(){
			a.reload();
		},
		...
		subscribelist:function(){
			js.subscribe({
				title:'會議('+nowtabs.name+')',
				cont:'會議('+nowtabs.name+')的列表的',
				explain:'訂閱[會議]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorumeet',url:'flow,input,daoru,modenum=meet',icons:'plus',name:'導入會議'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"會議室",dataIndex:"hyname",sortable:true},{text:"主題",dataIndex:"title",align:"left"},{text:"開始時間",dataIndex:"startdt"},{text:"結束時間",dataIndex:"enddt"},{text:"參會人",dataIndex:"joinname"},{text:"說明",dataIndex:"explain"},{text:"發起人",dataIndex:"optname",sortable:true},{text:"狀態",dataIndex:"state",sortable:true},{text:"會議紀要人",dataIndex:"jyname"},{
