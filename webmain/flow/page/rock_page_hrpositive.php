...
$(document).ready(function(){
	{params}
	var modenum = 'hrpositive',modename='轉正申請',isflow=1,modeid='32',atype = params.atype,pnum=params.pnum;
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'轉正申請('+nowtabs.name+')',
				cont:'轉正申請('+nowtabs.name+')的列表的',
				explain:'訂閱[轉正申請]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daoruhrpositive',url:'flow,input,daoru,modenum=hrpositive',icons:'plus',name:'導入轉正申請'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"申請日期",dataIndex:"applydt",sortable:true},{text:"職位",dataIndex:"ranking"},{text:"入職日期",dataIndex:"entrydt",sortable:true},{text:"試用到期日",dataIndex:"syenddt"},{text:"轉正日期",dataIndex:"positivedt",sortable:true},{text:"申請說明",dataIndex:"explain"},{text:"狀態",dataIndex:"statustext"},{
