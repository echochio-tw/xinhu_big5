...
$(document).ready(function(){
	{params}
	var modenum = 'hrredund',modename='離職申請',isflow=1,modeid='33',atype = params.atype,pnum=params.pnum;
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'離職申請('+nowtabs.name+')',
				cont:'離職申請('+nowtabs.name+')的列表的',
				explain:'訂閱[離職申請]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daoruhrredund',url:'flow,input,daoru,modenum=hrredund',icons:'plus',name:'導入離職申請'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"職位",dataIndex:"ranking",sortable:true},{text:"申請日期",dataIndex:"applydt",sortable:true},{text:"入職日期",dataIndex:"entrydt"},{text:"離職類型",dataIndex:"redundtype",sortable:true},{text:"離職日期",dataIndex:"quitdt",sortable:true},{text:"離職原因",dataIndex:"redundreson",sortable:true},{text:"說明",dataIndex:"explain",sortable:true},{text:"狀態",dataIndex:"statustext"},{
