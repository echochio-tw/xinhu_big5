...
*	來源：流程模塊→表單元素管理→[模塊.車輛信息登記]→生成列表頁
*/
...
$(document).ready(function(){
	{params}
	var modenum = 'carms',modename='車輛信息登記',isflow=0,modeid='58',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
var fieldsarr = [{"name":"申請人","fields":"base_name"},{"name":"申請人部門","fields":"base_deptname"},{"name":"單號","fields":"sericnum"},{"fields":"carid","name":"車輛","fieldstype":"select","ispx":"0","isalign":" 0","islb":"1"},{"fields":"otype","name":"登記類型","fieldstype":"rockcombo","ispx":"1","isalign": "0","islb":"1"},{"fields":"startdt","name":"開始日期","fieldstype":"date","ispx":"1","isalign" :"0","islb":"1"},{"fields":"enddt","name":"截止日期","fieldstype":"date","ispx":"1","isalign ":"0","islb":"1"},{"fields":"jianame","name":"駕駛員","fieldstype":"changeusercheck","ispx":"0"," isalign":"0","islb":"1"},{"fields":"unitname","name":"對應名稱","fieldstype":"text","ispx":"0", "isalign":"0","islb":"1"},{"fields":"money","name":"金額","fieldstype":"number","ispx":"1", "isalign":"0","islb":"1"},{"fields":"address","name":"地點","fieldstype":"text","ispx":"0", "isalign":"0","islb":"1"},{"fields":"explain","name":"說明","fieldstype":"textarea","ispx": "0","isalign":"0","islb":"1"},{"fields":"optname","name":"登記人","fieldstype":"text","ispx" :"0","isalign":"0","islb":"1"},{"fields":"optdt","name":"登記時間","fieldstype":"text","ispx ":"0","isalign":"0","islb":"1"},{"fields":"ztname","name":"狀態","fieldstype":"text","ispx ":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	var c = {
		reload:function(){
			a.reload();
		},
		...
		subscribelist:function(){
			js.subscribe({
				title:'車輛信息登記('+nowtabs.name+')',
				cont:'車輛信息登記('+nowtabs.name+')的列表的',
				explain:'訂閱[車輛信息登記]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorucarms',url:'flow,input,daoru,modenum=carms',icons:'plus',name:'導入車輛信息登記'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"車輛",dataIndex:"carid"},{text:"登記類型",dataIndex:"otype",sortable:true},{text:"開始日期",dataIndex:"startdt",sortable:true},{text:"截止日期",dataIndex:"enddt",sortable:true},{text:"駕駛員",dataIndex:"jianame"},{text:"對應名稱",dataIndex:"unitname"},{text:"金額",dataIndex:"money",sortable:true},{text:"地點",dataIndex:"address"},{text:"說明",dataIndex:"explain"},{text:"登記人",dataIndex:"optname"},{text:"登記時間",dataIndex:"optdt"},{text:"狀態",dataIndex:"ztname"},{
