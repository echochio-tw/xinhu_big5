...
$(document).ready(function(){
	{params}
	var modenum = 'hrtransfer',modename='人事調動',isflow=1,modeid='38',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
var fieldsarr = [{"name":"申請人","fields":"base_name"},{"name":"申請人部門","fields":"base_deptname"},{"name":"單號","fields":"sericnum"},{"fields":"tranname","name":"要調動人","fieldstype":"changeuser","ispx":"0","isalign":"0","islb":"1"},{"fields":"trantype","name":"調動類型","fieldstype":"rockcombo","ispx":"0","isalign":"0","islb":"1"},{"fields":"olddeptname","name":"原來部門","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"oldranking","name":"原來職位","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"newdeptname","name":"調動後部門","fieldstype":"changedept","ispx":"0","isalign":"0","islb":"1"},{"fields":"newranking","name":"調動後職位","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"effectivedt","name":"生效日期","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"explain","name":"說明","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	var c = {
		reload:function(){
			a.reload();
		},
		...
		subscribelist:function(){
			js.subscribe({
				title:'人事調動('+nowtabs.name+')',
				cont:'人事調動('+nowtabs.name+')的列表的',
				explain:'訂閱[人事調動]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daoruhrtransfer',url:'flow,input,daoru,modenum=hrtransfer',icons:'plus',name:'導入人事調動'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"要調動人",dataIndex:"tranname"},{text:"調動類型",dataIndex:"trantype"},{text:"原來部門",dataIndex:"olddeptname"},{text:"原來職位",dataIndex:"oldranking"},{text:"調動後部門",dataIndex:"newdeptname"},{text:"調動後職位",dataIndex:"newranking"},{text:"生效日期",dataIndex:"effectivedt",sortable:true},{text:"說明",dataIndex:"explain"},{text:"狀態",dataIndex:"statustext"},{
