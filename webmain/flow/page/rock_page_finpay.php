...
$(document).ready(function(){
	{params}
	var modenum = 'finpay',modename='付款申請',isflow=1,modeid='64',atype = params.atype,pnum=params.pnum;
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'付款申請('+nowtabs.name+')',
				cont:'付款申請('+nowtabs.name+')的列表的',
				explain:'訂閱[付款申請]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorufinpay',url:'flow,input,daoru,modenum=finpay',icons:'plus',name:'導入付款申請'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"付款編號",dataIndex:"num"},{text:"付款金額",dataIndex:"money",sortable:true},{text:"付款日期",dataIndex:"paydt",sortable:true},{text:"收款單位",dataIndex:"fullname"},{text:"收款銀行",dataIndex:"openbank"},{text:"收款帳號",dataIndex:"cardid"},{text:"付款方式",dataIndex:"paytype"},{text:"狀態",dataIndex:"statustext"},{
...
<div>
	...
	<tr>
		...
		<td style="padding-left:10px"><select class="form-control" style="width:120px" id="selstatus_{rand}"><option value="">-全部狀態-</option><option style="color:blue" value="0">待處理</option><option style="color:green" value="1">已付款</option><option style="color:#888888" value="5">已作廢</option><option style="color:#17B2B7" value="23">退回</option></select></td>
