...
$(document).ready(function(){
	{params}
	var modenum = 'finkai',modename='開票申請',isflow=1,modeid='65',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
var fieldsarr = [{"name":"申請人","fields":"base_name"},{"name":"申請人部門","fields":"base_deptname"},{"name":"單號","fields":"sericnum"},{"fields":"type","name":"類型","fieldstype":"fixed","ispx":"0","isalign":" 0","islb":"0"},{"fields":"name","name":"開票名稱","fieldstype":"text","ispx":"0","isalign": "0","islb":"1"},{"fields":"money","name":"開票金額","fieldstype":"number","ispx":"0","isalign" :"0","islb":"1"},{"fields":"paydt","name":"開票日期","fieldstype":"date","ispx":"0","isalign ":"0","islb":"1"},{"fields":"fullname","name":"公司單位名稱","fieldstype":"text","ispx":"0", "isalign":"0","islb":"1"},{"fields":"address","name":"公司地址","fieldstype":"text","ispx":"0" ,"isalign":"0","islb":"0"},{"fields":"tel","name":"聯繫電話","fieldstype":"text","ispx":"0 ","isalign":"0","islb":"0"},{"fields":"shibieid","name":"納稅識別號","fieldstype":"text","ispx": "0","isalign":"0","islb":"1"},{"fields":"openbank","name":"開戶行","fieldstype":"text","ispx ":"0","isalign":"0","islb":"0"},{"fields":"cardid","name":"開戶帳號","fieldstype":"text"," ispx":"0","isalign":"0","islb":"0"},{"fields":"paytype","name":"開票類型","fieldstype":"rockcombo", "ispx":"0","isalign":"0","islb":"1"},{"fields":"num","name":"相關單號","fieldstype":"text ","ispx":"0","isalign":"0","islb":"0"},{"fields":"explain","name":"說明","fieldstype":"textarea ","ispx":"0","isalign":"0","islb":"0"}],fieldsselarr= [];
	var c = {
		reload:function(){
			a.reload();
		},
		...
		subscribelist:function(){
			js.subscribe({
				title:'開票申請('+nowtabs.name+')',
				cont:'開票申請('+nowtabs.name+')的列表的',
				explain:'訂閱[開票申請]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorufinkai',url:'flow,input,daoru,modenum=finkai',icons:'plus',name:'導入開票申請'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"開票名稱",dataIndex:"name"},{text:"開票金額",dataIndex:"money"},{text:"開票日期",dataIndex:"paydt"},{text:"公司單位名稱",dataIndex:"fullname"},{text:"納稅識別號",dataIndex:"shibieid"},{text:"開票類型",dataIndex:"paytype"},{text:"狀態",dataIndex:"statustext"},{
...
<div>
	...
	<tr>
		...
		<td style="padding-left:10px"><select class="form-control" style="width:120px" id="selstatus_{rand}"><option value="">-全部狀態-</option><option style="color:blue" value="0">待處理</option><option style="color:green" value="1">已開票</option><option style="color:#888888" value="5">已作廢</option><option style="color:#17B2B7" value="23">退回</option></select></td>
