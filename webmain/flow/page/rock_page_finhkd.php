...
$(document).ready(function(){
	{params}
	var modenum = 'finhkd',modename='還款單',isflow=1,modeid='27',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
var fieldsarr = [{"name":"申請人","fields":"base_name"},{"name":"申請人部門","fields":"base_deptname"},{"name":"單號","fields":"sericnum"},{"fields":"type","name":"類型","fieldstype":"fixed","ispx":"0","isalign":" 0","islb":"0"},{"fields":"applydt","name":"申請日期","fieldstype":"text","ispx":"1","isalign": "0","islb":"1"},{"fields":"paytype","name":"付款方式","fieldstype":"rockcombo","ispx":"0","isalign" :"0","islb":"1"},{"fields":"fullname","name":"收款人全稱","fieldstype":"text","ispx":"0", "isalign":"0","islb":"1"},{"fields":"cardid","name":"收款帳號","fieldstype":"text","ispx":"0 ","isalign":"0","islb":"1"},{"fields":"money","name":"還款金額","fieldstype":"number","ispx": "1","isalign":"0","islb":"1"},{"fields":"moneycn","name":"還款金額大寫","fieldstype":"text"," ispx":"0","isalign":"0","islb":"0"},{"fields":"explain","name":"說明","fieldstype":"textarea"," ispx":"0","isalign":"0","islb":"1"},{"fields":"temp_money","name":"需還款金額","fields type":"auto","ispx":"0","isalign":"0","islb":"0"}],fieldsselarr= [];
	var c = {
		reload:function(){
			a.reload();
		},
		...
		subscribelist:function(){
			js.subscribe({
				title:'還款單('+nowtabs.name+')',
				cont:'還款單('+nowtabs.name+')的列表的',
				explain:'訂閱[還款單]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorufinhkd',url:'flow,input,daoru,modenum=finhkd',icons:'plus',name:'導入還款單'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"申請日期",dataIndex:"applydt",sortable:true},{text:"付款方式",dataIndex:"paytype"},{text:"收款人全稱",dataIndex:"fullname"},{text:"收款帳號",dataIndex:"cardid"},{text:"還款金額",dataIndex:"money",sortable:true},{text:"說明",dataIndex:"explain"},{text:"狀態",dataIndex:"statustext"},{
