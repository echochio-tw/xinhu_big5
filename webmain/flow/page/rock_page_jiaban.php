...
$(document).ready(function(){
	{params}
	var modenum = 'jiaban',modename='加班單',isflow=1,modeid='6',atype = params.atype,pnum=params.pnum;
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'加班單('+nowtabs.name+')',
				cont:'加班單('+nowtabs.name+')的列表的',
				explain:'訂閱[加班單]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorujiaban',url:'flow,input,daoru,modenum=jiaban',icons:'plus',name:'導入加班單'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"開始時間",dataIndex:"stime"},{text:"截止時間",dataIndex:"etime"},{text:"時間(小時)",dataIndex:"totals"},{text:"說明",dataIndex:"explain",align:"left"},{text:"加班兌換",dataIndex:"jiatype",sortable:true},{text:"加班費",dataIndex:"jiafee",sortable:true},{text:"狀態",dataIndex:"statustext"},{
