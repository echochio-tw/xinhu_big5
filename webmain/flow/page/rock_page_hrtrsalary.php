 ...
 var fieldsarr = [{"name":"申請人","fields":"base_name"},{"name":"申請人部門","fields":"base_deptname"},{"name":"單號","fields":"sericnum"},{"fields":"ranking","name":"職位","fieldstype":"text","ispx":"1","isalign":"0","islb":"1"},{"fields":"applydt","name":"申請日期","fieldstype":"date","ispx":"0","isalign":"0","islb":"1"},{"fields":"floats","name":"調薪幅度","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"},{"fields":"effectivedt","name":"生效日期","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"explain","name":"說明","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'調薪申請('+nowtabs.name+')',
				cont:'調薪申請('+nowtabs.name+')的列表的',
				explain:'訂閱[調薪申請]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daoruhrtrsalary',url:'flow,input,daoru,modenum=hrtrsalary',icons:'plus',name:'導入調薪申請'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"職位",dataIndex:"ranking",sortable:true},{text:"申請日期",dataIndex:"applydt"},{text:"調薪幅度",dataIndex:"floats",sortable:true},{text:"生效日期",dataIndex:"effectivedt",sortable:true},{text:"說明",dataIndex:"explain"},{text:"狀態",dataIndex:"statustext"},{
