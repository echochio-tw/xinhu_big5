...
$(document).ready(function(){
	{params}
	var modenum = 'reward',modename='獎懲處罰',isflow=1,modeid='39',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
var fieldsarr = [{"name":"申請人","fields":"base_name"},{"name":"申請人部門","fields":"base_deptname"},{"name":"單號","fields":"sericnum"},{"fields":"applydt","name":"申請日期","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"object","name":"獎懲對象","fieldstype":"changeuser","ispx":"1","isalign":"0","islb":"1"},{"fields":"happendt","name":"發生時間","fieldstype":"datetime","ispx":"0","isalign":"0","islb":"1"},{"fields":"hapaddress","name":"發生地點","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"type","name":"獎懲類型","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"result","name":"獎懲結果","fieldstype":"rockcombo","ispx":"0","isalign":"0","islb":"1"},{"fields":"money","name":"獎懲金額","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"說明","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	var c = {
		reload:function(){
			a.reload();
		},
		...
		subscribelist:function(){
			js.subscribe({
				title:'獎懲處罰('+nowtabs.name+')',
				cont:'獎懲處罰('+nowtabs.name+')的列表的',
				explain:'訂閱[獎懲處罰]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorureward',url:'flow,input,daoru,modenum=reward',icons:'plus',name:'導入獎懲處罰'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"申請日期",dataIndex:"applydt"},{text:"獎懲對象",dataIndex:"object",sortable:true},{text:"發生時間",dataIndex:"happendt"},{text:"發生地點",dataIndex:"hapaddress"},{text:"獎懲類型",dataIndex:"type"},{text:"獎懲結果",dataIndex:"result"},{text:"獎懲金額",dataIndex:"money"},{text:"說明",dataIndex:"explain"},{text:"狀態",dataIndex:"statustext"},{
