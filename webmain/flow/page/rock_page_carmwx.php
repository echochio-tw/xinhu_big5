...
$(document).ready(function(){
	{params}
	var modenum = 'carmwx',modename='車輛維修',isflow=1,modeid='59',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
var fieldsarr = [{"name":"申請人","fields":"base_name"},{"name":"申請人部門","fields":"base_deptname"},{"name":"單號","fields":"sericnum"},{"fields":"carid","name":"維修車輛","fieldstype":"select","ispx":"1","isalign": "0","islb":"1"},{"fields":"reason","name":"維修原因","fieldstype":"textarea","ispx":"0","isalign" :"0","islb":"1"},{"fields":"address","name":"維修地點","fieldstype":"text","ispx":"0","isalign ":"0","islb":"1"},{"fields":"jianame","name":"駕駛員","fieldstype":"changeusercheck","ispx":"0"," isalign":"0","islb":"1"},{"fields":"bujian","name":"更換部件","fieldstype":"text","ispx":"0", "isalign":"0","islb":"1"},{"fields":"startdt","name":"維修時間","fieldstype":"datetime","ispx":"0" ,"isalign":"0","islb":"1"},{"fields":"enddt","name":"維修截止時間","fieldstype":"datetime","ispx":" 1","isalign":"0","islb":"1"},{"fields":"money","name":"維修金額","fieldstype":"number","ispx": "0","isalign":"0","islb":"1"},{"fields":"explain","name":"說明"," fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	var c = {
		reload:function(){
			a.reload();
		},
		...
		subscribelist:function(){
			js.subscribe({
				title:'車輛維修('+nowtabs.name+')',
				cont:'車輛維修('+nowtabs.name+')的列表的',
				explain:'訂閱[車輛維修]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorucarmwx',url:'flow,input,daoru,modenum=carmwx',icons:'plus',name:'導入車輛維修'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"維修車輛",dataIndex:"carid",sortable:true},{text:"維修原因",dataIndex:"reason"},{text:"維修地點",dataIndex:"address"},{text:"駕駛員",dataIndex:"jianame"},{text:"更換部件",dataIndex:"bujian"},{text:"維修時間",dataIndex:"startdt"},{text:"維修截止時間",dataIndex:"enddt",sortable:true},{text:"維修金額",dataIndex:"money"},{text:"說明",dataIndex:"explain"},{text:"狀態",dataIndex:"statustext"},{
