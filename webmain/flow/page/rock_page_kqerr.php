...
$(document).ready(function(){
	{params}
	var modenum = 'kqerr',modename='打卡異常',isflow=1,modeid='51',atype = params.atype,pnum=params.pnum;
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'打卡異常('+nowtabs.name+')',
				cont:'打卡異常('+nowtabs.name+')的列表的',
				explain:'訂閱[打卡異常]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorukqerr',url:'flow,input,daoru,modenum=kqerr',icons:'plus',name:'導入打卡異常'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"異常類型",dataIndex:"errtype"},{text:"異常日期",dataIndex:"dt",sortable:true},{text:"應打卡時間",dataIndex:"ytime"},{text:"說明",dataIndex:"explain"},{text:"狀態",dataIndex:"statustext"},{
