...
$(document).ready(function(){
	...
	var c = {
		...
		daoru:function(){
			...
			addtabs({num:'daoruwaichu',url:'flow,input,daoru,modenum=waichu',icons:'plus',name:'導入外出出差'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"類型",dataIndex:"atype"},{text:"外出地址",dataIndex:"address"},{text:"外出時間",dataIndex:"outtime",sortable:true},{text:"預計回崗",dataIndex:"intime"},{text:"外出理由",dataIndex:"reason",align:"left"},{text:"說明",dataIndex:"explain",align:"left"},{text:"狀態",dataIndex:"statustext"},{
