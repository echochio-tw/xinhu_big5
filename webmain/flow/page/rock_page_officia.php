...
$(document).ready(function(){
	{params}
	var modenum = 'officia',modename='發文單',isflow=1,modeid='19',atype = params.atype,pnum=params.pnum;
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'發文單('+nowtabs.name+')',
				cont:'發文單('+nowtabs.name+')的列表的',
				explain:'訂閱[發文單]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daoruofficia',url:'flow,input,daoru,modenum=officia',icons:'plus',name:'導入發文單'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"公文編號",dataIndex:"num"},{text:"標題",dataIndex:"title"},{text:"發文單位",dataIndex:"unitsame"},{text:"公文等級",dataIndex:"grade"},{text:"接收單位",dataIndex:"unitname"},{text:"公文密級",dataIndex:"miji"},{text:"需查閱對象",dataIndex:"recename"},{text:"狀態",dataIndex:"statustext"},{
