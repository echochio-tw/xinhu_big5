...
$(document).ready(function(){
	{params}
	var modenum = 'finccbx',modename='出差報銷',isflow=1,modeid='25',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
var fieldsarr = [{"name":"申請人","fields":"base_name"},{"name":"申請人部門","fields":"base_deptname"},{"name":"單號","fields":"sericnum"},{"fields":"applydt","name":"申請日期","fieldstype":"text","ispx":"0","isalign": "0","islb":"1"},{"fields":"bills","name":"附單據(張)","fieldstype":"number","ispx":"0", "isalign":"0","islb":"0"},{"fields":"purpose","name":"出差目的","fieldstype":"text","ispx":"0" ,"isalign":"0","islb":"1"},{"fields":"purresult","name":"出差成果","fieldstype":"text","ispx":"0 ","isalign":"0","islb":"1"},{"fields":"fullname","name":"收款人全稱","fieldstype":"text","ispx" :"0","isalign":"0","islb":"0"},{"fields":"paytype","name":"付款方式","fieldstype":"rockcombo","ispx ":"0","isalign":"0","islb":"0"},{"fields":"cardid","name":"收款帳號","fieldstype":"text", "ispx":"0","isalign":"0","islb":"0"},{"fields":"openbank","name":"開戶行","fieldstype":"text" ,"ispx":"0","isalign":"0","islb":"0"},{"fields":"money","name":"報銷金額","fieldsty pe":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"moneycn","name":"大寫金額", "fieldstype":"text","ispx":"0","isalign":"0","islb":"0"},{"fields":"explain","name":"說明", "fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"type","name":"單據類型" ,"fieldstype":"fixed","ispx":"0","isalign":"0","islb":"0"}],fieldsselarr= [];
	var c = {
		reload:function(){
			a.reload();
		},
		...
		subscribelist:function(){
			js.subscribe({
				title:'出差報銷('+nowtabs.name+')',
				cont:'出差報銷('+nowtabs.name+')的列表的',
				explain:'訂閱[出差報銷]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorufinccbx',url:'flow,input,daoru,modenum=finccbx',icons:'plus',name:'導入出差報銷'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"申請日期",dataIndex:"applydt"},{text:"出差目的",dataIndex:"purpose"},{text:"出差成果",dataIndex:"purresult"},{text:"報銷金額",dataIndex:"money"},{text:"說明",dataIndex:"explain"},{text:"狀態",dataIndex:"statustext"},{
