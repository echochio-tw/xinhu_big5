...
$(document).ready(function(){
	...
	darr[1] = $('#view1_{rand}').bootstable({
		...
		columns:[{
			text:'部門',dataIndex:'name'
		},{
			text:'未寫人數',dataIndex:'value'
		}],
		load:function(a){
			c.loadcharts(1,'pie');
		}
	...
	darr[0] = $('#view0_{rand}').bootstable({
		...
		columns:[{
			...
			text:'應寫',dataIndex:'totaly',sortable:true
		},{
			text:'已寫',dataIndex:'totalx',sortable:true
		},{
			text:'未寫',dataIndex:'totalw',sortable:true
		}],
		load:function(d){
			$('#zttiel0_{rand}').html('日期['+d.ztdt+']未寫日報人員');
			$('#zttiel1_{rand}').html('日期['+d.ztdt+']根據部門統計未寫人員');
		}
	});
	...
	<tr valign="top">
		...
		<td width="50%">
			...
			<div class="list-group-item  list-group-item-info">
				<i class="icon-bar-chart"></i> <span id="zttiel0_{rand}">昨天未寫人員</span>
		...
		<td style="padding-left:10px;">
			...
			<div class="list-group-item  list-group-item-success">
				<i class="icon-bar-chart"></i> <span id="zttiel1_{rand}">根據部門統計已寫未寫人員</span>
