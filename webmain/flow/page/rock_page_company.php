...
$(document).ready(function(){
	{params}
	var modenum = 'company',modename='公司單位',isflow=0,modeid='63',atype = params.atype,pnum=params.pnum;
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'公司單位('+nowtabs.name+')',
				cont:'公司單位('+nowtabs.name+')的列表的',
				explain:'訂閱[公司單位]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorucompany',url:'flow,input,daoru,modenum=company',icons:'plus',name:'導入公司單位'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"名稱",dataIndex:"name",align:"left"},{text:"對應負責人",dataIndex:"fuzename"},{text:"所在城市",dataIndex:"city"},{text:"地址",dataIndex:"address",align:"left"},{text:"電話",dataIndex:"tel"},{text:"傳真",dataIndex:"fax"},{text:"排序號",dataIndex:"sort"},{text:"ID",dataIndex:"id"},{
