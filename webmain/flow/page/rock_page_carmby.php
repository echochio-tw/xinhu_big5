...
$(document).ready(function(){
	{params}
	var modenum = 'carmby',modename='車輛保養',isflow=1,modeid='60',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
var fieldsarr = [{"name":"申請人","fields":"base_name"},{"name":"申請人部門","fields":"base_deptname"},{"name":"單號","fields":"sericnum"},{"fields":"carid","name":"保養車輛","fieldstype":"select","ispx":"1","isalign": "0","islb":"1"},{"fields":"type","name":"單據類型","fieldstype":"fixed","ispx":"0","isalign" :"0","islb":"0"},{"fields":"jianame","name":"駕駛員","fieldstype":"changeusercheck","ispx":"0","isalign ":"0","islb":"1"},{"fields":"reason","name":"保養原因","fieldstype":"textarea","ispx":"0"," isalign":"0","islb":"1"},{"fields":"address","name":"保養地點","fieldstype":"text","ispx":"0", "isalign":"0","islb":"1"},{"fields":"bujian","name":"保養內容","fieldstype":"text","ispx":"0" ,"isalign":"0","islb":"1"},{"fields":"startdt","name":"保養時間","fieldstype":"datetime","ispx":"0 ","isalign":"0","islb":"1"},{"fields":"enddt","name":"取車時間","fieldstype":"datetime","ispx": "1","isalign":"0","islb":"1"},{"fields":"money","name":"保養金額","fiel dstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"kmshu","name":"當前保養公里數","fieldstype":"text","ispx":"0","isalign":"0","islb":"0"},{"fields":"nextdt","name":"下次保養日期","fieldstype":"date","ispx":"0","isalign":"0","islb":"1"},{"fields":"kmnshu","name" :"下次保養公里數","fieldstype":"text","ispx":"0","isalign":"0","islb":"0"},{"fields":"explain" ,"name":"說明","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"0"}],fieldsselarr= [];
	var c = {
		reload:function(){
			a.reload();
		},
		...
		subscribelist:function(){
			js.subscribe({
				title:'車輛保養('+nowtabs.name+')',
				cont:'車輛保養('+nowtabs.name+')的列表的',
				explain:'訂閱[車輛保養]的列表',
				objtable:a
			});
		},
		...
		daoru:function(){
			...
			addtabs({num:'daorucarmby',url:'flow,input,daoru,modenum=carmby',icons:'plus',name:'導入車輛保養'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申請人",dataIndex:"base_name",sortable:true},{text:"申請人部門",dataIndex:"base_deptname",sortable:true},{text:"單號",dataIndex:"sericnum"},{text:"保養車輛",dataIndex:"carid",sortable:true},{text:"駕駛員",dataIndex:"jianame"},{text:"保養原因",dataIndex:"reason"},{text:"保養地點",dataIndex:"address"},{text:"保養內容",dataIndex:"bujian"},{text:"保養時間",dataIndex:"startdt"},{text:"取車時間",dataIndex:"enddt",sortable:true},{text:"保養金額",dataIndex:"money"},{text:"下次保養日期",dataIndex:"nextdt"},{text:"狀態",dataIndex:"statustext"},{
